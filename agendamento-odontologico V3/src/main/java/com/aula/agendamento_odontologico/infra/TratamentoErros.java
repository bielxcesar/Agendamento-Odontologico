...
public class TratamentoErros {
    ...
    private record DadosErrosValidacao (String campo,String mesagem) {
    ...
    public ResponseEntity tratarErro409(DataIntegrityViolationException ex) {
        var erro = new DadosErrosDuplicidade ("Já existe um cadastro com os dados informados");
        return ResponseEntity.status(HttpStatus.CONFLICT).body(erro);
    }
    private record DadosErrosDuplicidade (String campo) {
